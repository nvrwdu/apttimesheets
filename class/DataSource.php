...
class DataSource
{
    ...
    const HOST = 'bfsskcwe2vodwtqgcre0-mysql.services.clever-cloud.com:3306';

    const USERNAME = 'uowghss4p4xphkl4';

    const PASSWORD = 'loPWnC7xBLtYHHzGM1Fw';

    const DATABASENAME = 'bfsskcwe2vodwtqgcre0';
